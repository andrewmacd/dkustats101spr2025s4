...
-   Lecture activity: [Lecture 1.1 activity](activities/Lecture 1.1/lecture.1.1.activity.zip)
...
-   Homework files: [Unit 1 homework](homeworks/Unit 1 homework/unit.1.homework.zip)
...
-   Lecture webpage: [Lecture 1.3](lectures/lecture.1.3.html)
...
-   Lecture webpage: [Lecture 2.3](lectures/lecture.2.3.html)
...
-   Lab files: [Lab 2.2](labs/Lab 2.2/lab.2.2.zip)
    -   Make sure to extract (unzip) the lab files before attempting to modify them!
...
-   Homework files: [Unit 2 homework instructions](homeworks/Unit 2 homework/unit.2.homework.zip)
...
-   Lecture webpage: [Lecture 2.4](lectures/lecture.2.4.html)
...
-   Lab files: [Lab 2.3](labs/Lab 2.3/lab.2.3.zip)
    -   Make sure to extract (unzip) the lab files before attempting to modify them!
...
-   Lecture webpage: [Lecture 3.1](lectures/lecture.3.1.html)
...
-   Lecture webpage: [Lecture 3.2](lectures/lecture.3.2.html)

-   Lecture activity: [Lecture 3.2 activity](activities/Lecture 3.2/lecture.3.2.activity.zip)
...
-   Lecture webpage: [Lecture 3.3](lectures/lecture.3.3.html)
...
-   Lecture webpage: [Lecture 3.4](lectures/lecture.3.4.html)
...
-   Final class reading: [Final class 4.3 reading](activities/Final class/Class 4.3 reading - Taking notes in the digital age.pdf)

-   Final class activity: [Final class 4.3 activity](activities/Final class/final.class.activity.zip)
